class HomeController < ApplicationController
 ...
 def get_weather
   ...
   response = HTTParty.get("http://api.wunderground.com/api/#{ENV['wunderground_api_key']}/geolookup/conditions/q/#{@state}/#{@city}.json") 
   ...
   #response = HTTParty.get("https://api.gettyimages.com/v3/search/images?phrase=#{@weather_words}", :headers => {"Api-Key" => ENV['gettyimages_api_key']})
  
  # @url = response ['images'][0]['display_sizes'][0]['uri']; -->
